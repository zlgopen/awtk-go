...
理论上 [AWTK](https://github.com/zlgopen/awtk)支持 Go 语言并不难，[AWTK](https://github.com/zlgopen/awtk) 已经支持 jerryscript、nodejs、quickjs、lua、python、java、minijvm 和 cpp 等语言的绑定。不过每种语言都有自己的特性，所以每次增加新的语言，也是对 [AWTK](https://github.com/zlgopen/awtk) 绑定机制的考验和完善。

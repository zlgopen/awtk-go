...
const (
	ALIGN_H_NONE   = C.ALIGN_H_NONE
	ALIGN_H_CENTER = C.ALIGN_H_CENTER
	ALIGN_H_LEFT   = C.ALIGN_H_LEFT
	ALIGN_H_RIGHT  = C.ALIGN_H_RIGHT
)

type TAlignV int

const (
	ALIGN_V_NONE   = C.ALIGN_V_NONE
	ALIGN_V_MIDDLE = C.ALIGN_V_MIDDLE
	ALIGN_V_TOP    = C.ALIGN_V_TOP
	ALIGN_V_BOTTOM = C.ALIGN_V_BOTTOM
)
...
const (
	...
	APP_SIMULATOR = C.APP_SIMULATOR
	APP_DESKTOP   = C.APP_DESKTOP
)
...
func (this TAssetInfo) GetIsInRom() uint8 {
	return (uint8)((*C.asset_info_t)(unsafe.Pointer(this.handle)).is_in_rom)
}
...
const (
	ASSET_TYPE_NONE    = C.ASSET_TYPE_NONE
	ASSET_TYPE_FONT    = C.ASSET_TYPE_FONT
	ASSET_TYPE_IMAGE   = C.ASSET_TYPE_IMAGE
	ASSET_TYPE_STYLE   = C.ASSET_TYPE_STYLE
	ASSET_TYPE_UI      = C.ASSET_TYPE_UI
	ASSET_TYPE_XML     = C.ASSET_TYPE_XML
	ASSET_TYPE_STRINGS = C.ASSET_TYPE_STRINGS
	ASSET_TYPE_SCRIPT  = C.ASSET_TYPE_SCRIPT
	ASSET_TYPE_FLOW    = C.ASSET_TYPE_FLOW
	ASSET_TYPE_DATA    = C.ASSET_TYPE_DATA
)
...
const (
	BIDI_TYPE_AUTO = C.BIDI_TYPE_AUTO
	BIDI_TYPE_LTR  = C.BIDI_TYPE_LTR
	BIDI_TYPE_RTL  = C.BIDI_TYPE_RTL
	BIDI_TYPE_LRO  = C.BIDI_TYPE_LRO
	BIDI_TYPE_RLO  = C.BIDI_TYPE_RLO
	BIDI_TYPE_WLTR = C.BIDI_TYPE_WLTR
	BIDI_TYPE_WRTL = C.BIDI_TYPE_WRTL
)
...
const (
	BITMAP_FLAG_NONE           = C.BITMAP_FLAG_NONE
	BITMAP_FLAG_OPAQUE         = C.BITMAP_FLAG_OPAQUE
	BITMAP_FLAG_IMMUTABLE      = C.BITMAP_FLAG_IMMUTABLE
	BITMAP_FLAG_TEXTURE        = C.BITMAP_FLAG_TEXTURE
	BITMAP_FLAG_CHANGED        = C.BITMAP_FLAG_CHANGED
	BITMAP_FLAG_PREMULTI_ALPHA = C.BITMAP_FLAG_PREMULTI_ALPHA
)

type TBitmapFormat int

const (
	BITMAP_FMT_NONE     = C.BITMAP_FMT_NONE
	BITMAP_FMT_RGBA8888 = C.BITMAP_FMT_RGBA8888
	BITMAP_FMT_ABGR8888 = C.BITMAP_FMT_ABGR8888
	BITMAP_FMT_BGRA8888 = C.BITMAP_FMT_BGRA8888
	BITMAP_FMT_ARGB8888 = C.BITMAP_FMT_ARGB8888
	BITMAP_FMT_RGB565   = C.BITMAP_FMT_RGB565
	BITMAP_FMT_BGR565   = C.BITMAP_FMT_BGR565
	BITMAP_FMT_RGB888   = C.BITMAP_FMT_RGB888
	BITMAP_FMT_BGR888   = C.BITMAP_FMT_BGR888
	BITMAP_FMT_GRAY     = C.BITMAP_FMT_GRAY
	BITMAP_FMT_MONO     = C.BITMAP_FMT_MONO
)
...
const (
	CLIP_BOARD_DATA_TYPE_NONE = C.CLIP_BOARD_DATA_TYPE_NONE
	CLIP_BOARD_DATA_TYPE_TEXT = C.CLIP_BOARD_DATA_TYPE_TEXT
)
...
const (
	DIALOG_QUIT_NONE   = C.DIALOG_QUIT_NONE
	DIALOG_QUIT_OK     = C.DIALOG_QUIT_OK
	DIALOG_QUIT_YES    = C.DIALOG_QUIT_YES
	DIALOG_QUIT_CANCEL = C.DIALOG_QUIT_CANCEL
	DIALOG_QUIT_NO     = C.DIALOG_QUIT_NO
	DIALOG_QUIT_OTHER  = C.DIALOG_QUIT_OTHER
)
...
const (
	EASING_LINEAR          = C.EASING_LINEAR
	EASING_QUADRATIC_IN    = C.EASING_QUADRATIC_IN
	EASING_QUADRATIC_OUT   = C.EASING_QUADRATIC_OUT
	EASING_QUADRATIC_INOUT = C.EASING_QUADRATIC_INOUT
	EASING_CUBIC_IN        = C.EASING_CUBIC_IN
	EASING_CUBIC_OUT       = C.EASING_CUBIC_OUT
	EASING_SIN_IN          = C.EASING_SIN_IN
	EASING_SIN_OUT         = C.EASING_SIN_OUT
	EASING_SIN_INOUT       = C.EASING_SIN_INOUT
	EASING_POW_IN          = C.EASING_POW_IN
	EASING_POW_OUT         = C.EASING_POW_OUT
	EASING_POW_INOUT       = C.EASING_POW_INOUT
	EASING_CIRCULAR_IN     = C.EASING_CIRCULAR_IN
	EASING_CIRCULAR_OUT    = C.EASING_CIRCULAR_OUT
	EASING_CIRCULAR_INOUT  = C.EASING_CIRCULAR_INOUT
	EASING_ELASTIC_IN      = C.EASING_ELASTIC_IN
	EASING_ELASTIC_OUT     = C.EASING_ELASTIC_OUT
	EASING_ELASTIC_INOUT   = C.EASING_ELASTIC_INOUT
	EASING_BACK_IN         = C.EASING_BACK_IN
	EASING_BACK_OUT        = C.EASING_BACK_OUT
	EASING_BACK_INOUT      = C.EASING_BACK_INOUT
	EASING_BOUNCE_IN       = C.EASING_BOUNCE_IN
	EASING_BOUNCE_OUT      = C.EASING_BOUNCE_OUT
	EASING_BOUNCE_INOUT    = C.EASING_BOUNCE_INOUT
)
...
const (
	EVT_POINTER_DOWN                 = C.EVT_POINTER_DOWN
	EVT_POINTER_DOWN_BEFORE_CHILDREN = C.EVT_POINTER_DOWN_BEFORE_CHILDREN
	EVT_POINTER_MOVE                 = C.EVT_POINTER_MOVE
	EVT_POINTER_MOVE_BEFORE_CHILDREN = C.EVT_POINTER_MOVE_BEFORE_CHILDREN
	EVT_POINTER_UP                   = C.EVT_POINTER_UP
	EVT_POINTER_UP_BEFORE_CHILDREN   = C.EVT_POINTER_UP_BEFORE_CHILDREN
	EVT_WHEEL                        = C.EVT_WHEEL
	EVT_WHEEL_BEFORE_CHILDREN        = C.EVT_WHEEL_BEFORE_CHILDREN
	EVT_POINTER_DOWN_ABORT           = C.EVT_POINTER_DOWN_ABORT
	EVT_CONTEXT_MENU                 = C.EVT_CONTEXT_MENU
	EVT_POINTER_ENTER                = C.EVT_POINTER_ENTER
	EVT_POINTER_LEAVE                = C.EVT_POINTER_LEAVE
	EVT_LONG_PRESS                   = C.EVT_LONG_PRESS
	EVT_CLICK                        = C.EVT_CLICK
	EVT_FOCUS                        = C.EVT_FOCUS
	EVT_BLUR                         = C.EVT_BLUR
	EVT_KEY_DOWN                     = C.EVT_KEY_DOWN
	EVT_KEY_LONG_PRESS               = C.EVT_KEY_LONG_PRESS
	EVT_KEY_DOWN_BEFORE_CHILDREN     = C.EVT_KEY_DOWN_BEFORE_CHILDREN
	EVT_KEY_REPEAT                   = C.EVT_KEY_REPEAT
	EVT_KEY_UP                       = C.EVT_KEY_UP
	EVT_KEY_UP_BEFORE_CHILDREN       = C.EVT_KEY_UP_BEFORE_CHILDREN
	EVT_WILL_MOVE                    = C.EVT_WILL_MOVE
	EVT_MOVE                         = C.EVT_MOVE
	EVT_WILL_RESIZE                  = C.EVT_WILL_RESIZE
	EVT_RESIZE                       = C.EVT_RESIZE
	EVT_WILL_MOVE_RESIZE             = C.EVT_WILL_MOVE_RESIZE
	EVT_MOVE_RESIZE                  = C.EVT_MOVE_RESIZE
	EVT_VALUE_WILL_CHANGE            = C.EVT_VALUE_WILL_CHANGE
	EVT_VALUE_CHANGED                = C.EVT_VALUE_CHANGED
	EVT_VALUE_CHANGING               = C.EVT_VALUE_CHANGING
	EVT_PAINT                        = C.EVT_PAINT
	EVT_BEFORE_PAINT                 = C.EVT_BEFORE_PAINT
	EVT_AFTER_PAINT                  = C.EVT_AFTER_PAINT
	EVT_PAINT_DONE                   = C.EVT_PAINT_DONE
	EVT_LOCALE_CHANGED               = C.EVT_LOCALE_CHANGED
	EVT_ANIM_START                   = C.EVT_ANIM_START
	EVT_ANIM_STOP                    = C.EVT_ANIM_STOP
	EVT_ANIM_PAUSE                   = C.EVT_ANIM_PAUSE
	EVT_ANIM_ONCE                    = C.EVT_ANIM_ONCE
	EVT_ANIM_END                     = C.EVT_ANIM_END
	EVT_WINDOW_LOAD                  = C.EVT_WINDOW_LOAD
	EVT_WIDGET_LOAD                  = C.EVT_WIDGET_LOAD
	EVT_WINDOW_WILL_OPEN             = C.EVT_WINDOW_WILL_OPEN
	EVT_WINDOW_OPEN                  = C.EVT_WINDOW_OPEN
	EVT_WINDOW_TO_BACKGROUND         = C.EVT_WINDOW_TO_BACKGROUND
	EVT_WINDOW_TO_FOREGROUND         = C.EVT_WINDOW_TO_FOREGROUND
	EVT_WINDOW_CLOSE                 = C.EVT_WINDOW_CLOSE
	EVT_REQUEST_CLOSE_WINDOW         = C.EVT_REQUEST_CLOSE_WINDOW
	EVT_TOP_WINDOW_CHANGED           = C.EVT_TOP_WINDOW_CHANGED
	EVT_IM_START                     = C.EVT_IM_START
	EVT_IM_STOP                      = C.EVT_IM_STOP
	EVT_IM_COMMIT                    = C.EVT_IM_COMMIT
	EVT_IM_CLEAR                     = C.EVT_IM_CLEAR
	EVT_IM_CANCEL                    = C.EVT_IM_CANCEL
	EVT_IM_PREEDIT                   = C.EVT_IM_PREEDIT
	EVT_IM_PREEDIT_CONFIRM           = C.EVT_IM_PREEDIT_CONFIRM
	EVT_IM_PREEDIT_ABORT             = C.EVT_IM_PREEDIT_ABORT
	EVT_IM_SHOW_CANDIDATES           = C.EVT_IM_SHOW_CANDIDATES
	EVT_IM_SHOW_PRE_CANDIDATES       = C.EVT_IM_SHOW_PRE_CANDIDATES
	EVT_IM_LANG_CHANGED              = C.EVT_IM_LANG_CHANGED
	EVT_IM_ACTION                    = C.EVT_IM_ACTION
	EVT_IM_ACTION_INFO               = C.EVT_IM_ACTION_INFO
	EVT_DRAG_START                   = C.EVT_DRAG_START
	EVT_DRAG                         = C.EVT_DRAG
	EVT_DRAG_END                     = C.EVT_DRAG_END
	EVT_RESET                        = C.EVT_RESET
	EVT_SCREEN_SAVER                 = C.EVT_SCREEN_SAVER
	EVT_LOW_MEMORY                   = C.EVT_LOW_MEMORY
	EVT_OUT_OF_MEMORY                = C.EVT_OUT_OF_MEMORY
	EVT_ORIENTATION_WILL_CHANGED     = C.EVT_ORIENTATION_WILL_CHANGED
	EVT_ORIENTATION_CHANGED          = C.EVT_ORIENTATION_CHANGED
	EVT_WIDGET_CREATED               = C.EVT_WIDGET_CREATED
	EVT_REQUEST_QUIT_APP             = C.EVT_REQUEST_QUIT_APP
	EVT_THEME_CHANGED                = C.EVT_THEME_CHANGED
	EVT_WIDGET_ADD_CHILD             = C.EVT_WIDGET_ADD_CHILD
	EVT_WIDGET_REMOVE_CHILD          = C.EVT_WIDGET_REMOVE_CHILD
	EVT_SCROLL_START                 = C.EVT_SCROLL_START
	EVT_SCROLL                       = C.EVT_SCROLL
	EVT_SCROLL_END                   = C.EVT_SCROLL_END
	EVT_MULTI_GESTURE                = C.EVT_MULTI_GESTURE
	EVT_PAGE_CHANGED                 = C.EVT_PAGE_CHANGED
	EVT_ASSET_MANAGER_LOAD_ASSET     = C.EVT_ASSET_MANAGER_LOAD_ASSET
	EVT_ASSET_MANAGER_UNLOAD_ASSET   = C.EVT_ASSET_MANAGER_UNLOAD_ASSET
	EVT_ASSET_MANAGER_CLEAR_CACHE    = C.EVT_ASSET_MANAGER_CLEAR_CACHE
	EVT_TIMER                        = C.EVT_TIMER
	EVT_REQ_START                    = C.EVT_REQ_START
	EVT_USER_START                   = C.EVT_USER_START
	EVT_NONE                         = C.EVT_NONE
	EVT_PROP_WILL_CHANGE             = C.EVT_PROP_WILL_CHANGE
	EVT_PROP_CHANGED                 = C.EVT_PROP_CHANGED
	EVT_CMD_WILL_EXEC                = C.EVT_CMD_WILL_EXEC
	EVT_CMD_EXECED                   = C.EVT_CMD_EXECED
	EVT_CMD_CAN_EXEC                 = C.EVT_CMD_CAN_EXEC
	EVT_ITEMS_WILL_CHANGE            = C.EVT_ITEMS_WILL_CHANGE
	EVT_ITEMS_CHANGED                = C.EVT_ITEMS_CHANGED
	EVT_PROPS_CHANGED                = C.EVT_PROPS_CHANGED
	EVT_PROGRESS                     = C.EVT_PROGRESS
	EVT_DONE                         = C.EVT_DONE
	EVT_ERROR                        = C.EVT_ERROR
	EVT_DESTROY                      = C.EVT_DESTROY
)
...
const (
	GLYPH_FMT_ALPHA = C.GLYPH_FMT_ALPHA
	GLYPH_FMT_MONO  = C.GLYPH_FMT_MONO
	GLYPH_FMT_RGBA  = C.GLYPH_FMT_RGBA
)
...
func TGuageCreate(parent TWidget, x int, y int, w int, h int) TWidget {
	retObj := TGuage{}
	retObj.handle = unsafe.Pointer(C.guage_create((*C.widget_t)(parent.handle), (C.xy_t)(x), (C.xy_t)(y), (C.wh_t)(w), (C.wh_t)(h)))
	return retObj.TWidget
}

func TGuageCast(widget TWidget) TGuage {
	retObj := TGuage{}
	retObj.handle = unsafe.Pointer(C.guage_cast((*C.widget_t)(widget.handle)))
	return retObj
}

func (this TGuage) SetImage(name string) TRet {
	aname := C.CString(name)
	defer C.free(unsafe.Pointer(aname))
	return TRet(C.guage_set_image((*C.widget_t)(this.handle), aname))
}

func (this TGuage) SetDrawType(draw_type TImageDrawType) TRet {
	return TRet(C.guage_set_draw_type((*C.widget_t)(this.handle), (C.image_draw_type_t)(draw_type)))
}

func (this TGuage) GetImage() string {
	return C.GoString((*C.guage_t)(unsafe.Pointer(this.handle)).image)
}

func (this TGuage) GetDrawType() TImageDrawType {
	return TImageDrawType((*C.guage_t)(unsafe.Pointer(this.handle)).draw_type)
}

type TGuagePointer struct {
	TWidget
}

func TGuagePointerCreate(parent TWidget, x int, y int, w int, h int) TWidget {
	retObj := TGuagePointer{}
	retObj.handle = unsafe.Pointer(C.guage_pointer_create((*C.widget_t)(parent.handle), (C.xy_t)(x), (C.xy_t)(y), (C.wh_t)(w), (C.wh_t)(h)))
	return retObj.TWidget
}

func TGuagePointerCast(widget TWidget) TGuagePointer {
	retObj := TGuagePointer{}
	retObj.handle = unsafe.Pointer(C.guage_pointer_cast((*C.widget_t)(widget.handle)))
	return retObj
}

func (this TGuagePointer) SetAngle(angle int32) TRet {
	return TRet(C.guage_pointer_set_angle((*C.widget_t)(this.handle), (C.int32_t)(angle)))
}

func (this TGuagePointer) SetImage(image string) TRet {
	aimage := C.CString(image)
	defer C.free(unsafe.Pointer(aimage))
	return TRet(C.guage_pointer_set_image((*C.widget_t)(this.handle), aimage))
}

func (this TGuagePointer) SetAnchor(anchor_x string, anchor_y string) TRet {
	...
	return TRet(C.guage_pointer_set_anchor((*C.widget_t)(this.handle), aanchor_x, aanchor_y))
}

func (this TGuagePointer) GetAngle() int32 {
	return (int32)((*C.guage_pointer_t)(unsafe.Pointer(this.handle)).angle)
}

func (this TGuagePointer) GetImage() string {
	return C.GoString((*C.guage_pointer_t)(unsafe.Pointer(this.handle)).image)
}

func (this TGuagePointer) GetAnchorX() string {
	return C.GoString((*C.guage_pointer_t)(unsafe.Pointer(this.handle)).anchor_x)
}

func (this TGuagePointer) GetAnchorY() string {
	return C.GoString((*C.guage_pointer_t)(unsafe.Pointer(this.handle)).anchor_y)
}
...
const (
	IMAGE_DRAW_DEFAULT          = C.IMAGE_DRAW_DEFAULT
	IMAGE_DRAW_CENTER           = C.IMAGE_DRAW_CENTER
	IMAGE_DRAW_ICON             = C.IMAGE_DRAW_ICON
	IMAGE_DRAW_SCALE            = C.IMAGE_DRAW_SCALE
	IMAGE_DRAW_SCALE_AUTO       = C.IMAGE_DRAW_SCALE_AUTO
	IMAGE_DRAW_SCALE_DOWN       = C.IMAGE_DRAW_SCALE_DOWN
	IMAGE_DRAW_SCALE_W          = C.IMAGE_DRAW_SCALE_W
	IMAGE_DRAW_SCALE_H          = C.IMAGE_DRAW_SCALE_H
	IMAGE_DRAW_REPEAT           = C.IMAGE_DRAW_REPEAT
	IMAGE_DRAW_REPEAT_X         = C.IMAGE_DRAW_REPEAT_X
	IMAGE_DRAW_REPEAT_Y         = C.IMAGE_DRAW_REPEAT_Y
	IMAGE_DRAW_REPEAT_Y_INVERSE = C.IMAGE_DRAW_REPEAT_Y_INVERSE
	IMAGE_DRAW_PATCH9           = C.IMAGE_DRAW_PATCH9
	IMAGE_DRAW_PATCH3_X         = C.IMAGE_DRAW_PATCH3_X
	IMAGE_DRAW_PATCH3_Y         = C.IMAGE_DRAW_PATCH3_Y
	IMAGE_DRAW_PATCH3_X_SCALE_Y = C.IMAGE_DRAW_PATCH3_X_SCALE_Y
	IMAGE_DRAW_PATCH3_Y_SCALE_X = C.IMAGE_DRAW_PATCH3_Y_SCALE_X
	IMAGE_DRAW_REPEAT9          = C.IMAGE_DRAW_REPEAT9
	IMAGE_DRAW_REPEAT3_X        = C.IMAGE_DRAW_REPEAT3_X
	IMAGE_DRAW_REPEAT3_Y        = C.IMAGE_DRAW_REPEAT3_Y
)
...
const (
	INDICATOR_DEFAULT_PAINT_AUTO        = C.INDICATOR_DEFAULT_PAINT_AUTO
	INDICATOR_DEFAULT_PAINT_FILL_DOT    = C.INDICATOR_DEFAULT_PAINT_FILL_DOT
	INDICATOR_DEFAULT_PAINT_STROKE_DOT  = C.INDICATOR_DEFAULT_PAINT_STROKE_DOT
	INDICATOR_DEFAULT_PAINT_FILL_RECT   = C.INDICATOR_DEFAULT_PAINT_FILL_RECT
	INDICATOR_DEFAULT_PAINT_STROKE_RECT = C.INDICATOR_DEFAULT_PAINT_STROKE_RECT
)
...
const (
	...
	INPUT_INT             = C.INPUT_INT
	INPUT_UINT            = C.INPUT_UINT
	INPUT_HEX             = C.INPUT_HEX
	INPUT_FLOAT           = C.INPUT_FLOAT
	INPUT_UFLOAT          = C.INPUT_UFLOAT
	INPUT_EMAIL           = C.INPUT_EMAIL
	INPUT_PASSWORD        = C.INPUT_PASSWORD
	INPUT_PHONE           = C.INPUT_PHONE
	INPUT_IPV4            = C.INPUT_IPV4
	INPUT_DATE            = C.INPUT_DATE
	INPUT_TIME            = C.INPUT_TIME
	INPUT_TIME_FULL       = C.INPUT_TIME_FULL
	INPUT_CUSTOM          = C.INPUT_CUSTOM
	INPUT_CUSTOM_PASSWORD = C.INPUT_CUSTOM_PASSWORD
	INPUT_ASCII           = C.INPUT_ASCII
)

type TKeyCode int

const (
	TK_KEY_RETURN       = C.TK_KEY_RETURN
	TK_KEY_ESCAPE       = C.TK_KEY_ESCAPE
	TK_KEY_BACKSPACE    = C.TK_KEY_BACKSPACE
	TK_KEY_TAB          = C.TK_KEY_TAB
	TK_KEY_SPACE        = C.TK_KEY_SPACE
	TK_KEY_EXCLAIM      = C.TK_KEY_EXCLAIM
	TK_KEY_QUOTEDBL     = C.TK_KEY_QUOTEDBL
	TK_KEY_HASH         = C.TK_KEY_HASH
	TK_KEY_PERCENT      = C.TK_KEY_PERCENT
	TK_KEY_DOLLAR       = C.TK_KEY_DOLLAR
	TK_KEY_AMPERSAND    = C.TK_KEY_AMPERSAND
	TK_KEY_QUOTE        = C.TK_KEY_QUOTE
	TK_KEY_LEFTPAREN    = C.TK_KEY_LEFTPAREN
	TK_KEY_RIGHTPAREN   = C.TK_KEY_RIGHTPAREN
	TK_KEY_ASTERISK     = C.TK_KEY_ASTERISK
	TK_KEY_PLUS         = C.TK_KEY_PLUS
	TK_KEY_COMMA        = C.TK_KEY_COMMA
	TK_KEY_MINUS        = C.TK_KEY_MINUS
	TK_KEY_PERIOD       = C.TK_KEY_PERIOD
	TK_KEY_SLASH        = C.TK_KEY_SLASH
	TK_KEY_0            = C.TK_KEY_0
	TK_KEY_1            = C.TK_KEY_1
	TK_KEY_2            = C.TK_KEY_2
	TK_KEY_3            = C.TK_KEY_3
	...
	TK_KEY_8            = C.TK_KEY_8
	TK_KEY_9            = C.TK_KEY_9
	TK_KEY_COLON        = C.TK_KEY_COLON
	TK_KEY_SEMICOLON    = C.TK_KEY_SEMICOLON
	TK_KEY_LESS         = C.TK_KEY_LESS
	TK_KEY_EQUAL        = C.TK_KEY_EQUAL
	TK_KEY_GREATER      = C.TK_KEY_GREATER
	TK_KEY_QUESTION     = C.TK_KEY_QUESTION
	TK_KEY_AT           = C.TK_KEY_AT
	TK_KEY_LEFTBRACKET  = C.TK_KEY_LEFTBRACKET
	TK_KEY_BACKSLASH    = C.TK_KEY_BACKSLASH
	TK_KEY_RIGHTBRACKET = C.TK_KEY_RIGHTBRACKET
	TK_KEY_CARET        = C.TK_KEY_CARET
	TK_KEY_UNDERSCORE   = C.TK_KEY_UNDERSCORE
	TK_KEY_BACKQUOTE    = C.TK_KEY_BACKQUOTE
	TK_KEY_a            = C.TK_KEY_a
	TK_KEY_b            = C.TK_KEY_b
	TK_KEY_c            = C.TK_KEY_c
	TK_KEY_d            = C.TK_KEY_d
	...
	TK_KEY_Y            = C.TK_KEY_Y
	TK_KEY_Z            = C.TK_KEY_Z
	TK_KEY_DOT          = C.TK_KEY_DOT
	TK_KEY_DELETE       = C.TK_KEY_DELETE
	TK_KEY_LEFTBRACE    = C.TK_KEY_LEFTBRACE
	TK_KEY_RIGHTBRACE   = C.TK_KEY_RIGHTBRACE
	TK_KEY_LSHIFT       = C.TK_KEY_LSHIFT
	TK_KEY_RSHIFT       = C.TK_KEY_RSHIFT
	TK_KEY_LCTRL        = C.TK_KEY_LCTRL
	TK_KEY_RCTRL        = C.TK_KEY_RCTRL
	TK_KEY_LALT         = C.TK_KEY_LALT
	TK_KEY_RALT         = C.TK_KEY_RALT
	TK_KEY_CAPSLOCK     = C.TK_KEY_CAPSLOCK
	TK_KEY_HOME         = C.TK_KEY_HOME
	TK_KEY_END          = C.TK_KEY_END
	TK_KEY_INSERT       = C.TK_KEY_INSERT
	TK_KEY_UP           = C.TK_KEY_UP
	TK_KEY_DOWN         = C.TK_KEY_DOWN
	TK_KEY_LEFT         = C.TK_KEY_LEFT
	TK_KEY_RIGHT        = C.TK_KEY_RIGHT
	TK_KEY_PAGEUP       = C.TK_KEY_PAGEUP
	TK_KEY_PAGEDOWN     = C.TK_KEY_PAGEDOWN
	TK_KEY_F1           = C.TK_KEY_F1
	TK_KEY_F2           = C.TK_KEY_F2
	TK_KEY_F3           = C.TK_KEY_F3
	TK_KEY_F4           = C.TK_KEY_F4
	TK_KEY_F5           = C.TK_KEY_F5
	TK_KEY_F6           = C.TK_KEY_F6
	TK_KEY_F7           = C.TK_KEY_F7
	TK_KEY_F8           = C.TK_KEY_F8
	TK_KEY_F9           = C.TK_KEY_F9
	TK_KEY_F10          = C.TK_KEY_F10
	TK_KEY_F11          = C.TK_KEY_F11
	TK_KEY_F12          = C.TK_KEY_F12
	TK_KEY_MENU         = C.TK_KEY_MENU
	TK_KEY_COMMAND      = C.TK_KEY_COMMAND
	TK_KEY_BACK         = C.TK_KEY_BACK
	TK_KEY_CANCEL       = C.TK_KEY_CANCEL
	TK_KEY_WHEEL        = C.TK_KEY_WHEEL
)
...
const (
	MIME_TYPE_APPLICATION_ENVOY               = C.MIME_TYPE_APPLICATION_ENVOY
	MIME_TYPE_APPLICATION_FRACTALS            = C.MIME_TYPE_APPLICATION_FRACTALS
	MIME_TYPE_APPLICATION_FUTURESPLASH        = C.MIME_TYPE_APPLICATION_FUTURESPLASH
	MIME_TYPE_APPLICATION_HTA                 = C.MIME_TYPE_APPLICATION_HTA
	MIME_TYPE_APPLICATION_JSON                = C.MIME_TYPE_APPLICATION_JSON
	MIME_TYPE_APPLICATION_UBJSON              = C.MIME_TYPE_APPLICATION_UBJSON
	MIME_TYPE_APPLICATION_MAC_BINHEX40        = C.MIME_TYPE_APPLICATION_MAC_BINHEX40
	MIME_TYPE_APPLICATION_MSWORD              = C.MIME_TYPE_APPLICATION_MSWORD
	MIME_TYPE_APPLICATION_OCTET_STREAM        = C.MIME_TYPE_APPLICATION_OCTET_STREAM
	MIME_TYPE_APPLICATION_ODA                 = C.MIME_TYPE_APPLICATION_ODA
	MIME_TYPE_APPLICATION_OLESCRIPT           = C.MIME_TYPE_APPLICATION_OLESCRIPT
	MIME_TYPE_APPLICATION_PDF                 = C.MIME_TYPE_APPLICATION_PDF
	MIME_TYPE_APPLICATION_PICS_RULES          = C.MIME_TYPE_APPLICATION_PICS_RULES
	MIME_TYPE_APPLICATION_PKCS10              = C.MIME_TYPE_APPLICATION_PKCS10
	MIME_TYPE_APPLICATION_PKIX_CRL            = C.MIME_TYPE_APPLICATION_PKIX_CRL
	MIME_TYPE_APPLICATION_POSTSCRIPT          = C.MIME_TYPE_APPLICATION_POSTSCRIPT
	MIME_TYPE_APPLICATION_RTF                 = C.MIME_TYPE_APPLICATION_RTF
	MIME_TYPE_APPLICATION_VND_MS_EXCEL        = C.MIME_TYPE_APPLICATION_VND_MS_EXCEL
	MIME_TYPE_APPLICATION_VND_MS_OUTLOOK      = C.MIME_TYPE_APPLICATION_VND_MS_OUTLOOK
	MIME_TYPE_APPLICATION_VND_MS_PKICERTSTORE = C.MIME_TYPE_APPLICATION_VND_MS_PKICERTSTORE
	MIME_TYPE_APPLICATION_VND_MS_PKISECCAT    = C.MIME_TYPE_APPLICATION_VND_MS_PKISECCAT
	MIME_TYPE_APPLICATION_VND_MS_PKISTL       = C.MIME_TYPE_APPLICATION_VND_MS_PKISTL
	MIME_TYPE_APPLICATION_VND_MS_POWERPOINT   = C.MIME_TYPE_APPLICATION_VND_MS_POWERPOINT
	MIME_TYPE_APPLICATION_VND_MS_PROJECT      = C.MIME_TYPE_APPLICATION_VND_MS_PROJECT
	MIME_TYPE_APPLICATION_VND_MS_WORKS        = C.MIME_TYPE_APPLICATION_VND_MS_WORKS
	MIME_TYPE_APPLICATION_WINHLP              = C.MIME_TYPE_APPLICATION_WINHLP
	MIME_TYPE_APPLICATION_X_BCPIO             = C.MIME_TYPE_APPLICATION_X_BCPIO
	MIME_TYPE_APPLICATION_X_CDF               = C.MIME_TYPE_APPLICATION_X_CDF
	MIME_TYPE_APPLICATION_X_COMPRESS          = C.MIME_TYPE_APPLICATION_X_COMPRESS
	MIME_TYPE_APPLICATION_X_COMPRESSED        = C.MIME_TYPE_APPLICATION_X_COMPRESSED
	MIME_TYPE_APPLICATION_X_CPIO              = C.MIME_TYPE_APPLICATION_X_CPIO
	MIME_TYPE_APPLICATION_X_CSH               = C.MIME_TYPE_APPLICATION_X_CSH
	MIME_TYPE_APPLICATION_X_DIRECTOR          = C.MIME_TYPE_APPLICATION_X_DIRECTOR
	MIME_TYPE_APPLICATION_X_DVI               = C.MIME_TYPE_APPLICATION_X_DVI
	MIME_TYPE_APPLICATION_X_GTAR              = C.MIME_TYPE_APPLICATION_X_GTAR
	MIME_TYPE_APPLICATION_X_GZIP              = C.MIME_TYPE_APPLICATION_X_GZIP
	MIME_TYPE_APPLICATION_X_HDF               = C.MIME_TYPE_APPLICATION_X_HDF
	MIME_TYPE_APPLICATION_X_IPHONE            = C.MIME_TYPE_APPLICATION_X_IPHONE
	MIME_TYPE_APPLICATION_X_JAVASCRIPT        = C.MIME_TYPE_APPLICATION_X_JAVASCRIPT
	MIME_TYPE_APPLICATION_X_LATEX             = C.MIME_TYPE_APPLICATION_X_LATEX
	MIME_TYPE_APPLICATION_X_MSACCESS          = C.MIME_TYPE_APPLICATION_X_MSACCESS
	MIME_TYPE_APPLICATION_X_MSCARDFILE        = C.MIME_TYPE_APPLICATION_X_MSCARDFILE
	MIME_TYPE_APPLICATION_X_MSCLIP            = C.MIME_TYPE_APPLICATION_X_MSCLIP
	MIME_TYPE_APPLICATION_X_MSDOWNLOAD        = C.MIME_TYPE_APPLICATION_X_MSDOWNLOAD
	MIME_TYPE_APPLICATION_X_MSMEDIAVIEW       = C.MIME_TYPE_APPLICATION_X_MSMEDIAVIEW
	MIME_TYPE_APPLICATION_X_MSMETAFILE        = C.MIME_TYPE_APPLICATION_X_MSMETAFILE
	MIME_TYPE_APPLICATION_X_MSMONEY           = C.MIME_TYPE_APPLICATION_X_MSMONEY
	MIME_TYPE_APPLICATION_X_MSPUBLISHER       = C.MIME_TYPE_APPLICATION_X_MSPUBLISHER
	MIME_TYPE_APPLICATION_X_MSSCHEDULE        = C.MIME_TYPE_APPLICATION_X_MSSCHEDULE
	MIME_TYPE_APPLICATION_X_MSTERMINAL        = C.MIME_TYPE_APPLICATION_X_MSTERMINAL
	MIME_TYPE_APPLICATION_X_MSWRITE           = C.MIME_TYPE_APPLICATION_X_MSWRITE
	MIME_TYPE_APPLICATION_X_NETCDF            = C.MIME_TYPE_APPLICATION_X_NETCDF
	MIME_TYPE_APPLICATION_X_PERFMON           = C.MIME_TYPE_APPLICATION_X_PERFMON
	MIME_TYPE_APPLICATION_X_PKCS12            = C.MIME_TYPE_APPLICATION_X_PKCS12
	MIME_TYPE_APPLICATION_X_SH                = C.MIME_TYPE_APPLICATION_X_SH
	MIME_TYPE_APPLICATION_X_SHAR              = C.MIME_TYPE_APPLICATION_X_SHAR
	MIME_TYPE_APPLICATION_X_SHOCKWAVE_FLASH   = C.MIME_TYPE_APPLICATION_X_SHOCKWAVE_FLASH
	MIME_TYPE_APPLICATION_X_STUFFIT           = C.MIME_TYPE_APPLICATION_X_STUFFIT
	MIME_TYPE_APPLICATION_X_SV4CPIO           = C.MIME_TYPE_APPLICATION_X_SV4CPIO
	MIME_TYPE_APPLICATION_X_SV4CRC            = C.MIME_TYPE_APPLICATION_X_SV4CRC
	MIME_TYPE_APPLICATION_X_TAR               = C.MIME_TYPE_APPLICATION_X_TAR
	MIME_TYPE_APPLICATION_X_TCL               = C.MIME_TYPE_APPLICATION_X_TCL
	MIME_TYPE_APPLICATION_X_TEX               = C.MIME_TYPE_APPLICATION_X_TEX
	MIME_TYPE_APPLICATION_X_TEXINFO           = C.MIME_TYPE_APPLICATION_X_TEXINFO
	MIME_TYPE_APPLICATION_X_TROFF             = C.MIME_TYPE_APPLICATION_X_TROFF
	MIME_TYPE_APPLICATION_X_USTAR             = C.MIME_TYPE_APPLICATION_X_USTAR
	MIME_TYPE_APPLICATION_ZIP                 = C.MIME_TYPE_APPLICATION_ZIP
	MIME_TYPE_AUDIO_BASIC                     = C.MIME_TYPE_AUDIO_BASIC
	MIME_TYPE_AUDIO_MID                       = C.MIME_TYPE_AUDIO_MID
	MIME_TYPE_AUDIO_MPEG                      = C.MIME_TYPE_AUDIO_MPEG
	MIME_TYPE_AUDIO_X_AIFF                    = C.MIME_TYPE_AUDIO_X_AIFF
	MIME_TYPE_AUDIO_X_MPEGURL                 = C.MIME_TYPE_AUDIO_X_MPEGURL
	MIME_TYPE_AUDIO_X_WAV                     = C.MIME_TYPE_AUDIO_X_WAV
	MIME_TYPE_IMAGE_BMP                       = C.MIME_TYPE_IMAGE_BMP
	MIME_TYPE_IMAGE_CIS_COD                   = C.MIME_TYPE_IMAGE_CIS_COD
	MIME_TYPE_IMAGE_GIF                       = C.MIME_TYPE_IMAGE_GIF
	MIME_TYPE_IMAGE_IEF                       = C.MIME_TYPE_IMAGE_IEF
	MIME_TYPE_IMAGE_JPEG                      = C.MIME_TYPE_IMAGE_JPEG
	MIME_TYPE_IMAGE_PIPEG                     = C.MIME_TYPE_IMAGE_PIPEG
	MIME_TYPE_IMAGE_SVG_XML                   = C.MIME_TYPE_IMAGE_SVG_XML
	MIME_TYPE_IMAGE_TIFF                      = C.MIME_TYPE_IMAGE_TIFF
	MIME_TYPE_IMAGE_X_CMX                     = C.MIME_TYPE_IMAGE_X_CMX
	MIME_TYPE_IMAGE_X_ICON                    = C.MIME_TYPE_IMAGE_X_ICON
	MIME_TYPE_IMAGE_X_RGB                     = C.MIME_TYPE_IMAGE_X_RGB
	MIME_TYPE_IMAGE_X_XBITMAP                 = C.MIME_TYPE_IMAGE_X_XBITMAP
	MIME_TYPE_IMAGE_X_XPIXMAP                 = C.MIME_TYPE_IMAGE_X_XPIXMAP
	MIME_TYPE_IMAGE_X_XWINDOWDUMP             = C.MIME_TYPE_IMAGE_X_XWINDOWDUMP
	MIME_TYPE_MESSAGE_RFC822                  = C.MIME_TYPE_MESSAGE_RFC822
	MIME_TYPE_TEXT_CSS                        = C.MIME_TYPE_TEXT_CSS
	MIME_TYPE_TEXT_H323                       = C.MIME_TYPE_TEXT_H323
	MIME_TYPE_TEXT_HTML                       = C.MIME_TYPE_TEXT_HTML
	MIME_TYPE_TEXT_IULS                       = C.MIME_TYPE_TEXT_IULS
	MIME_TYPE_TEXT_PLAIN                      = C.MIME_TYPE_TEXT_PLAIN
	MIME_TYPE_TEXT_RICHTEXT                   = C.MIME_TYPE_TEXT_RICHTEXT
	MIME_TYPE_TEXT_SCRIPTLET                  = C.MIME_TYPE_TEXT_SCRIPTLET
	MIME_TYPE_TEXT_WEBVIEWHTML                = C.MIME_TYPE_TEXT_WEBVIEWHTML
	MIME_TYPE_TEXT_X_COMPONENT                = C.MIME_TYPE_TEXT_X_COMPONENT
	MIME_TYPE_TEXT_X_SETEXT                   = C.MIME_TYPE_TEXT_X_SETEXT
	MIME_TYPE_TEXT_X_VCARD                    = C.MIME_TYPE_TEXT_X_VCARD
	MIME_TYPE_VIDEO_MPEG                      = C.MIME_TYPE_VIDEO_MPEG
	MIME_TYPE_VIDEO_QUICKTIME                 = C.MIME_TYPE_VIDEO_QUICKTIME
	MIME_TYPE_VIDEO_X_MSVIDEO                 = C.MIME_TYPE_VIDEO_X_MSVIDEO
)
...
const (
	OBJECT_CMD_SAVE           = C.OBJECT_CMD_SAVE
	OBJECT_CMD_RELOAD         = C.OBJECT_CMD_RELOAD
	OBJECT_CMD_MOVE_UP        = C.OBJECT_CMD_MOVE_UP
	OBJECT_CMD_MOVE_DOWN      = C.OBJECT_CMD_MOVE_DOWN
	OBJECT_CMD_REMOVE         = C.OBJECT_CMD_REMOVE
	OBJECT_CMD_REMOVE_CHECKED = C.OBJECT_CMD_REMOVE_CHECKED
	OBJECT_CMD_CLEAR          = C.OBJECT_CMD_CLEAR
	OBJECT_CMD_ADD            = C.OBJECT_CMD_ADD
	OBJECT_CMD_DETAIL         = C.OBJECT_CMD_DETAIL
	OBJECT_CMD_EDIT           = C.OBJECT_CMD_EDIT
)
...
const (
	OBJECT_PROP_SIZE    = C.OBJECT_PROP_SIZE
	OBJECT_PROP_CHECKED = C.OBJECT_PROP_CHECKED
)
...
const (
	...
	RET_OOM            = C.RET_OOM
	RET_FAIL           = C.RET_FAIL
	RET_NOT_IMPL       = C.RET_NOT_IMPL
	RET_QUIT           = C.RET_QUIT
	RET_FOUND          = C.RET_FOUND
	RET_BUSY           = C.RET_BUSY
	RET_REMOVE         = C.RET_REMOVE
	RET_REPEAT         = C.RET_REPEAT
	RET_NOT_FOUND      = C.RET_NOT_FOUND
	RET_DONE           = C.RET_DONE
	RET_STOP           = C.RET_STOP
	RET_SKIP           = C.RET_SKIP
	RET_CONTINUE       = C.RET_CONTINUE
	RET_OBJECT_CHANGED = C.RET_OBJECT_CHANGED
	RET_ITEMS_CHANGED  = C.RET_ITEMS_CHANGED
	RET_BAD_PARAMS     = C.RET_BAD_PARAMS
	RET_TIMEOUT        = C.RET_TIMEOUT
	RET_CRC            = C.RET_CRC
	RET_IO             = C.RET_IO
	RET_EOS            = C.RET_EOS
	RET_NOT_MODIFIED   = C.RET_NOT_MODIFIED
)
...
const (
	STYLE_ID_BG_COLOR                  = C.STYLE_ID_BG_COLOR
	STYLE_ID_FG_COLOR                  = C.STYLE_ID_FG_COLOR
	STYLE_ID_MASK_COLOR                = C.STYLE_ID_MASK_COLOR
	STYLE_ID_FONT_NAME                 = C.STYLE_ID_FONT_NAME
	STYLE_ID_FONT_SIZE                 = C.STYLE_ID_FONT_SIZE
	STYLE_ID_FONT_STYLE                = C.STYLE_ID_FONT_STYLE
	STYLE_ID_TEXT_COLOR                = C.STYLE_ID_TEXT_COLOR
	STYLE_ID_HIGHLIGHT_FONT_NAME       = C.STYLE_ID_HIGHLIGHT_FONT_NAME
	STYLE_ID_HIGHLIGHT_FONT_SIZE       = C.STYLE_ID_HIGHLIGHT_FONT_SIZE
	STYLE_ID_HIGHLIGHT_TEXT_COLOR      = C.STYLE_ID_HIGHLIGHT_TEXT_COLOR
	STYLE_ID_TIPS_TEXT_COLOR           = C.STYLE_ID_TIPS_TEXT_COLOR
	STYLE_ID_TEXT_ALIGN_H              = C.STYLE_ID_TEXT_ALIGN_H
	STYLE_ID_TEXT_ALIGN_V              = C.STYLE_ID_TEXT_ALIGN_V
	STYLE_ID_BORDER_COLOR              = C.STYLE_ID_BORDER_COLOR
	STYLE_ID_BORDER_WIDTH              = C.STYLE_ID_BORDER_WIDTH
	STYLE_ID_BORDER                    = C.STYLE_ID_BORDER
	STYLE_ID_BG_IMAGE                  = C.STYLE_ID_BG_IMAGE
	STYLE_ID_BG_IMAGE_DRAW_TYPE        = C.STYLE_ID_BG_IMAGE_DRAW_TYPE
	STYLE_ID_ICON                      = C.STYLE_ID_ICON
	STYLE_ID_FG_IMAGE                  = C.STYLE_ID_FG_IMAGE
	STYLE_ID_FG_IMAGE_DRAW_TYPE        = C.STYLE_ID_FG_IMAGE_DRAW_TYPE
	STYLE_ID_SPACER                    = C.STYLE_ID_SPACER
	STYLE_ID_MARGIN                    = C.STYLE_ID_MARGIN
	STYLE_ID_MARGIN_LEFT               = C.STYLE_ID_MARGIN_LEFT
	STYLE_ID_MARGIN_RIGHT              = C.STYLE_ID_MARGIN_RIGHT
	STYLE_ID_MARGIN_TOP                = C.STYLE_ID_MARGIN_TOP
	STYLE_ID_MARGIN_BOTTOM             = C.STYLE_ID_MARGIN_BOTTOM
	STYLE_ID_ICON_AT                   = C.STYLE_ID_ICON_AT
	STYLE_ID_ACTIVE_ICON               = C.STYLE_ID_ACTIVE_ICON
	STYLE_ID_X_OFFSET                  = C.STYLE_ID_X_OFFSET
	STYLE_ID_Y_OFFSET                  = C.STYLE_ID_Y_OFFSET
	STYLE_ID_SELECTED_BG_COLOR         = C.STYLE_ID_SELECTED_BG_COLOR
	STYLE_ID_SELECTED_FG_COLOR         = C.STYLE_ID_SELECTED_FG_COLOR
	STYLE_ID_SELECTED_TEXT_COLOR       = C.STYLE_ID_SELECTED_TEXT_COLOR
	STYLE_ID_ROUND_RADIUS              = C.STYLE_ID_ROUND_RADIUS
	STYLE_ID_ROUND_RADIUS_TOP_LETF     = C.STYLE_ID_ROUND_RADIUS_TOP_LETF
	STYLE_ID_ROUND_RADIUS_TOP_RIGHT    = C.STYLE_ID_ROUND_RADIUS_TOP_RIGHT
	STYLE_ID_ROUND_RADIUS_BOTTOM_LETF  = C.STYLE_ID_ROUND_RADIUS_BOTTOM_LETF
	STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT = C.STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT
	STYLE_ID_CHILDREN_LAYOUT           = C.STYLE_ID_CHILDREN_LAYOUT
	STYLE_ID_SELF_LAYOUT               = C.STYLE_ID_SELF_LAYOUT
)
...
func (this TValue) Uint8() int8 {
	return (int8)(C.value_uint8((*C.value_t)(this.handle)))
}
...
const (
	VALUE_TYPE_INVALID      = C.VALUE_TYPE_INVALID
	VALUE_TYPE_BOOL         = C.VALUE_TYPE_BOOL
	VALUE_TYPE_INT8         = C.VALUE_TYPE_INT8
	VALUE_TYPE_UINT8        = C.VALUE_TYPE_UINT8
	VALUE_TYPE_INT16        = C.VALUE_TYPE_INT16
	VALUE_TYPE_UINT16       = C.VALUE_TYPE_UINT16
	VALUE_TYPE_INT32        = C.VALUE_TYPE_INT32
	VALUE_TYPE_UINT32       = C.VALUE_TYPE_UINT32
	VALUE_TYPE_INT64        = C.VALUE_TYPE_INT64
	VALUE_TYPE_UINT64       = C.VALUE_TYPE_UINT64
	VALUE_TYPE_POINTER      = C.VALUE_TYPE_POINTER
	VALUE_TYPE_FLOAT        = C.VALUE_TYPE_FLOAT
	VALUE_TYPE_FLOAT32      = C.VALUE_TYPE_FLOAT32
	VALUE_TYPE_DOUBLE       = C.VALUE_TYPE_DOUBLE
	VALUE_TYPE_STRING       = C.VALUE_TYPE_STRING
	VALUE_TYPE_WSTRING      = C.VALUE_TYPE_WSTRING
	VALUE_TYPE_OBJECT       = C.VALUE_TYPE_OBJECT
	VALUE_TYPE_SIZED_STRING = C.VALUE_TYPE_SIZED_STRING
	VALUE_TYPE_BINARY       = C.VALUE_TYPE_BINARY
	VALUE_TYPE_UBJSON       = C.VALUE_TYPE_UBJSON
	VALUE_TYPE_TOKEN        = C.VALUE_TYPE_TOKEN
)
...
const (
	VGCANVAS_LINE_CAP_ROUND  = C.VGCANVAS_LINE_CAP_ROUND
	VGCANVAS_LINE_CAP_SQUARE = C.VGCANVAS_LINE_CAP_SQUARE
	VGCANVAS_LINE_CAP_BUTT   = C.VGCANVAS_LINE_CAP_BUTT
)

type TVgcanvasLineJoin string

const (
	VGCANVAS_LINE_JOIN_ROUND  = C.VGCANVAS_LINE_JOIN_ROUND
	VGCANVAS_LINE_JOIN_BEVEL  = C.VGCANVAS_LINE_JOIN_BEVEL
	VGCANVAS_LINE_JOIN_MITTER = C.VGCANVAS_LINE_JOIN_MITTER
)
...
func (this TWidget) SetValue(value int32) TRet {
	return TRet(C.widget_set_value((*C.widget_t)(this.handle), (C.int32_t)(value)))
}

func (this TWidget) AnimateValueTo(value int32, duration uint32) TRet {
	return TRet(C.widget_animate_value_to((*C.widget_t)(this.handle), (C.int32_t)(value), (C.uint32_t)(duration)))
}

func (this TWidget) AddValue(delta int32) TRet {
	return TRet(C.widget_add_value((*C.widget_t)(this.handle), (C.int32_t)(delta)))
}
...
func (this TWidget) GetValue() int32 {
	return (int32)(C.widget_get_value((*C.widget_t)(this.handle)))
}
...
const (
	WIDGET_CURSOR_DEFAULT  = C.WIDGET_CURSOR_DEFAULT
	WIDGET_CURSOR_EDIT     = C.WIDGET_CURSOR_EDIT
	WIDGET_CURSOR_HAND     = C.WIDGET_CURSOR_HAND
	WIDGET_CURSOR_WAIT     = C.WIDGET_CURSOR_WAIT
	WIDGET_CURSOR_CROSS    = C.WIDGET_CURSOR_CROSS
	WIDGET_CURSOR_NO       = C.WIDGET_CURSOR_NO
	WIDGET_CURSOR_SIZENWSE = C.WIDGET_CURSOR_SIZENWSE
	WIDGET_CURSOR_SIZENESW = C.WIDGET_CURSOR_SIZENESW
	WIDGET_CURSOR_SIZEWE   = C.WIDGET_CURSOR_SIZEWE
	WIDGET_CURSOR_SIZENS   = C.WIDGET_CURSOR_SIZENS
	WIDGET_CURSOR_SIZEALL  = C.WIDGET_CURSOR_SIZEALL
)

type TWidgetProp string

const (
	WIDGET_PROP_EXEC                     = C.WIDGET_PROP_EXEC
	WIDGET_PROP_X                        = C.WIDGET_PROP_X
	WIDGET_PROP_Y                        = C.WIDGET_PROP_Y
	WIDGET_PROP_W                        = C.WIDGET_PROP_W
	WIDGET_PROP_H                        = C.WIDGET_PROP_H
	WIDGET_PROP_DESIGN_W                 = C.WIDGET_PROP_DESIGN_W
	WIDGET_PROP_DESIGN_H                 = C.WIDGET_PROP_DESIGN_H
	WIDGET_PROP_AUTO_SCALE_CHILDREN_X    = C.WIDGET_PROP_AUTO_SCALE_CHILDREN_X
	WIDGET_PROP_AUTO_SCALE_CHILDREN_Y    = C.WIDGET_PROP_AUTO_SCALE_CHILDREN_Y
	WIDGET_PROP_AUTO_SCALE_CHILDREN_W    = C.WIDGET_PROP_AUTO_SCALE_CHILDREN_W
	WIDGET_PROP_AUTO_SCALE_CHILDREN_H    = C.WIDGET_PROP_AUTO_SCALE_CHILDREN_H
	WIDGET_PROP_INPUTING                 = C.WIDGET_PROP_INPUTING
	WIDGET_PROP_ALWAYS_ON_TOP            = C.WIDGET_PROP_ALWAYS_ON_TOP
	WIDGET_PROP_CARET_X                  = C.WIDGET_PROP_CARET_X
	WIDGET_PROP_CARET_Y                  = C.WIDGET_PROP_CARET_Y
	WIDGET_PROP_DIRTY_RECT_TOLERANCE     = C.WIDGET_PROP_DIRTY_RECT_TOLERANCE
	WIDGET_PROP_BIDI                     = C.WIDGET_PROP_BIDI
	WIDGET_PROP_CANVAS                   = C.WIDGET_PROP_CANVAS
	WIDGET_PROP_LOCALIZE_OPTIONS         = C.WIDGET_PROP_LOCALIZE_OPTIONS
	WIDGET_PROP_NATIVE_WINDOW            = C.WIDGET_PROP_NATIVE_WINDOW
	WIDGET_PROP_HIGHLIGHT                = C.WIDGET_PROP_HIGHLIGHT
	WIDGET_PROP_BAR_SIZE                 = C.WIDGET_PROP_BAR_SIZE
	WIDGET_PROP_OPACITY                  = C.WIDGET_PROP_OPACITY
	WIDGET_PROP_MIN_W                    = C.WIDGET_PROP_MIN_W
	WIDGET_PROP_MAX_W                    = C.WIDGET_PROP_MAX_W
	WIDGET_PROP_AUTO_ADJUST_SIZE         = C.WIDGET_PROP_AUTO_ADJUST_SIZE
	WIDGET_PROP_SINGLE_INSTANCE          = C.WIDGET_PROP_SINGLE_INSTANCE
	WIDGET_PROP_CHILDREN_LAYOUT          = C.WIDGET_PROP_CHILDREN_LAYOUT
	WIDGET_PROP_LAYOUT                   = C.WIDGET_PROP_LAYOUT
	WIDGET_PROP_SELF_LAYOUT              = C.WIDGET_PROP_SELF_LAYOUT
	WIDGET_PROP_LAYOUT_W                 = C.WIDGET_PROP_LAYOUT_W
	WIDGET_PROP_LAYOUT_H                 = C.WIDGET_PROP_LAYOUT_H
	WIDGET_PROP_VIRTUAL_W                = C.WIDGET_PROP_VIRTUAL_W
	WIDGET_PROP_VIRTUAL_H                = C.WIDGET_PROP_VIRTUAL_H
	WIDGET_PROP_NAME                     = C.WIDGET_PROP_NAME
	WIDGET_PROP_TYPE                     = C.WIDGET_PROP_TYPE
	WIDGET_PROP_CLOSABLE                 = C.WIDGET_PROP_CLOSABLE
	WIDGET_PROP_POINTER_CURSOR           = C.WIDGET_PROP_POINTER_CURSOR
	WIDGET_PROP_VALUE                    = C.WIDGET_PROP_VALUE
	WIDGET_PROP_REVERSE                  = C.WIDGET_PROP_REVERSE
	WIDGET_PROP_LENGTH                   = C.WIDGET_PROP_LENGTH
	WIDGET_PROP_LINE_WRAP                = C.WIDGET_PROP_LINE_WRAP
	WIDGET_PROP_WORD_WRAP                = C.WIDGET_PROP_WORD_WRAP
	WIDGET_PROP_TEXT                     = C.WIDGET_PROP_TEXT
	WIDGET_PROP_TR_TEXT                  = C.WIDGET_PROP_TR_TEXT
	WIDGET_PROP_STYLE                    = C.WIDGET_PROP_STYLE
	WIDGET_PROP_ENABLE                   = C.WIDGET_PROP_ENABLE
	WIDGET_PROP_FEEDBACK                 = C.WIDGET_PROP_FEEDBACK
	WIDGET_PROP_FLOATING                 = C.WIDGET_PROP_FLOATING
	WIDGET_PROP_MARGIN                   = C.WIDGET_PROP_MARGIN
	WIDGET_PROP_SPACING                  = C.WIDGET_PROP_SPACING
	WIDGET_PROP_LEFT_MARGIN              = C.WIDGET_PROP_LEFT_MARGIN
	WIDGET_PROP_RIGHT_MARGIN             = C.WIDGET_PROP_RIGHT_MARGIN
	WIDGET_PROP_TOP_MARGIN               = C.WIDGET_PROP_TOP_MARGIN
	WIDGET_PROP_BOTTOM_MARGIN            = C.WIDGET_PROP_BOTTOM_MARGIN
	WIDGET_PROP_STEP                     = C.WIDGET_PROP_STEP
	WIDGET_PROP_VISIBLE                  = C.WIDGET_PROP_VISIBLE
	WIDGET_PROP_SENSITIVE                = C.WIDGET_PROP_SENSITIVE
	WIDGET_PROP_ANIMATION                = C.WIDGET_PROP_ANIMATION
	WIDGET_PROP_ANIM_HINT                = C.WIDGET_PROP_ANIM_HINT
	WIDGET_PROP_FULLSCREEN               = C.WIDGET_PROP_FULLSCREEN
	WIDGET_PROP_DISABLE_ANIM             = C.WIDGET_PROP_DISABLE_ANIM
	WIDGET_PROP_OPEN_ANIM_HINT           = C.WIDGET_PROP_OPEN_ANIM_HINT
	WIDGET_PROP_CLOSE_ANIM_HINT          = C.WIDGET_PROP_CLOSE_ANIM_HINT
	WIDGET_PROP_MIN                      = C.WIDGET_PROP_MIN
	WIDGET_PROP_ACTION_TEXT              = C.WIDGET_PROP_ACTION_TEXT
	WIDGET_PROP_TIPS                     = C.WIDGET_PROP_TIPS
	WIDGET_PROP_TR_TIPS                  = C.WIDGET_PROP_TR_TIPS
	WIDGET_PROP_INPUT_TYPE               = C.WIDGET_PROP_INPUT_TYPE
	WIDGET_PROP_KEYBOARD                 = C.WIDGET_PROP_KEYBOARD
	WIDGET_PROP_DEFAULT_FOCUSED_CHILD    = C.WIDGET_PROP_DEFAULT_FOCUSED_CHILD
	WIDGET_PROP_READONLY                 = C.WIDGET_PROP_READONLY
	WIDGET_PROP_CANCELABLE               = C.WIDGET_PROP_CANCELABLE
	WIDGET_PROP_PASSWORD_VISIBLE         = C.WIDGET_PROP_PASSWORD_VISIBLE
	WIDGET_PROP_ACTIVE                   = C.WIDGET_PROP_ACTIVE
	WIDGET_PROP_CURR_PAGE                = C.WIDGET_PROP_CURR_PAGE
	WIDGET_PROP_PAGE_MAX_NUMBER          = C.WIDGET_PROP_PAGE_MAX_NUMBER
	WIDGET_PROP_VERTICAL                 = C.WIDGET_PROP_VERTICAL
	WIDGET_PROP_SHOW_TEXT                = C.WIDGET_PROP_SHOW_TEXT
	WIDGET_PROP_XOFFSET                  = C.WIDGET_PROP_XOFFSET
	WIDGET_PROP_YOFFSET                  = C.WIDGET_PROP_YOFFSET
	WIDGET_PROP_ALIGN_V                  = C.WIDGET_PROP_ALIGN_V
	WIDGET_PROP_ALIGN_H                  = C.WIDGET_PROP_ALIGN_H
	WIDGET_PROP_AUTO_PLAY                = C.WIDGET_PROP_AUTO_PLAY
	WIDGET_PROP_LOOP                     = C.WIDGET_PROP_LOOP
	WIDGET_PROP_AUTO_FIX                 = C.WIDGET_PROP_AUTO_FIX
	WIDGET_PROP_SELECT_NONE_WHEN_FOCUSED = C.WIDGET_PROP_SELECT_NONE_WHEN_FOCUSED
	WIDGET_PROP_OPEN_IM_WHEN_FOCUSED     = C.WIDGET_PROP_OPEN_IM_WHEN_FOCUSED
	WIDGET_PROP_CLOSE_IM_WHEN_BLURED     = C.WIDGET_PROP_CLOSE_IM_WHEN_BLURED
	WIDGET_PROP_X_MIN                    = C.WIDGET_PROP_X_MIN
	WIDGET_PROP_X_MAX                    = C.WIDGET_PROP_X_MAX
	WIDGET_PROP_Y_MIN                    = C.WIDGET_PROP_Y_MIN
	WIDGET_PROP_Y_MAX                    = C.WIDGET_PROP_Y_MAX
	WIDGET_PROP_MAX                      = C.WIDGET_PROP_MAX
	WIDGET_PROP_GRAB_KEYS                = C.WIDGET_PROP_GRAB_KEYS
	WIDGET_PROP_ROW                      = C.WIDGET_PROP_ROW
	WIDGET_PROP_STATE_FOR_STYLE          = C.WIDGET_PROP_STATE_FOR_STYLE
	WIDGET_PROP_THEME                    = C.WIDGET_PROP_THEME
	WIDGET_PROP_STAGE                    = C.WIDGET_PROP_STAGE
	WIDGET_PROP_IMAGE_MANAGER            = C.WIDGET_PROP_IMAGE_MANAGER
	WIDGET_PROP_ASSETS_MANAGER           = C.WIDGET_PROP_ASSETS_MANAGER
	WIDGET_PROP_LOCALE_INFO              = C.WIDGET_PROP_LOCALE_INFO
	WIDGET_PROP_FONT_MANAGER             = C.WIDGET_PROP_FONT_MANAGER
	WIDGET_PROP_THEME_OBJ                = C.WIDGET_PROP_THEME_OBJ
	WIDGET_PROP_DEFAULT_THEME_OBJ        = C.WIDGET_PROP_DEFAULT_THEME_OBJ
	WIDGET_PROP_ITEM_WIDTH               = C.WIDGET_PROP_ITEM_WIDTH
	WIDGET_PROP_ITEM_HEIGHT              = C.WIDGET_PROP_ITEM_HEIGHT
	WIDGET_PROP_DEFAULT_ITEM_HEIGHT      = C.WIDGET_PROP_DEFAULT_ITEM_HEIGHT
	WIDGET_PROP_XSLIDABLE                = C.WIDGET_PROP_XSLIDABLE
	WIDGET_PROP_YSLIDABLE                = C.WIDGET_PROP_YSLIDABLE
	WIDGET_PROP_REPEAT                   = C.WIDGET_PROP_REPEAT
	WIDGET_PROP_LONG_PRESS_TIME          = C.WIDGET_PROP_LONG_PRESS_TIME
	WIDGET_PROP_ENABLE_LONG_PRESS        = C.WIDGET_PROP_ENABLE_LONG_PRESS
	WIDGET_PROP_CLICK_THROUGH            = C.WIDGET_PROP_CLICK_THROUGH
	WIDGET_PROP_ANIMATABLE               = C.WIDGET_PROP_ANIMATABLE
	WIDGET_PROP_AUTO_HIDE_SCROLL_BAR     = C.WIDGET_PROP_AUTO_HIDE_SCROLL_BAR
	WIDGET_PROP_IMAGE                    = C.WIDGET_PROP_IMAGE
	WIDGET_PROP_FORMAT                   = C.WIDGET_PROP_FORMAT
	WIDGET_PROP_DRAW_TYPE                = C.WIDGET_PROP_DRAW_TYPE
	WIDGET_PROP_SELECTABLE               = C.WIDGET_PROP_SELECTABLE
	WIDGET_PROP_CLICKABLE                = C.WIDGET_PROP_CLICKABLE
	WIDGET_PROP_SCALE_X                  = C.WIDGET_PROP_SCALE_X
	WIDGET_PROP_SCALE_Y                  = C.WIDGET_PROP_SCALE_Y
	WIDGET_PROP_ANCHOR_X                 = C.WIDGET_PROP_ANCHOR_X
	WIDGET_PROP_ANCHOR_Y                 = C.WIDGET_PROP_ANCHOR_Y
	WIDGET_PROP_ROTATION                 = C.WIDGET_PROP_ROTATION
	WIDGET_PROP_COMPACT                  = C.WIDGET_PROP_COMPACT
	WIDGET_PROP_SCROLLABLE               = C.WIDGET_PROP_SCROLLABLE
	WIDGET_PROP_ICON                     = C.WIDGET_PROP_ICON
	WIDGET_PROP_OPTIONS                  = C.WIDGET_PROP_OPTIONS
	WIDGET_PROP_SELECTED                 = C.WIDGET_PROP_SELECTED
	WIDGET_PROP_CHECKED                  = C.WIDGET_PROP_CHECKED
	WIDGET_PROP_ACTIVE_ICON              = C.WIDGET_PROP_ACTIVE_ICON
	WIDGET_PROP_LOAD_UI                  = C.WIDGET_PROP_LOAD_UI
	WIDGET_PROP_OPEN_WINDOW              = C.WIDGET_PROP_OPEN_WINDOW
	WIDGET_PROP_SELECTED_INDEX           = C.WIDGET_PROP_SELECTED_INDEX
	WIDGET_PROP_CLOSE_WHEN_CLICK         = C.WIDGET_PROP_CLOSE_WHEN_CLICK
	WIDGET_PROP_CLOSE_WHEN_CLICK_OUTSIDE = C.WIDGET_PROP_CLOSE_WHEN_CLICK_OUTSIDE
	WIDGET_PROP_CLOSE_WHEN_TIMEOUT       = C.WIDGET_PROP_CLOSE_WHEN_TIMEOUT
	WIDGET_PROP_LINE_GAP                 = C.WIDGET_PROP_LINE_GAP
	WIDGET_PROP_BG_COLOR                 = C.WIDGET_PROP_BG_COLOR
	WIDGET_PROP_BORDER_COLOR             = C.WIDGET_PROP_BORDER_COLOR
	WIDGET_PROP_DELAY                    = C.WIDGET_PROP_DELAY
	WIDGET_PROP_IS_KEYBOARD              = C.WIDGET_PROP_IS_KEYBOARD
	WIDGET_PROP_FOCUSED                  = C.WIDGET_PROP_FOCUSED
	WIDGET_PROP_FOCUS                    = C.WIDGET_PROP_FOCUS
	WIDGET_PROP_FOCUSABLE                = C.WIDGET_PROP_FOCUSABLE
	WIDGET_PROP_WITH_FOCUS_STATE         = C.WIDGET_PROP_WITH_FOCUS_STATE
	WIDGET_PROP_MOVE_FOCUS_PREV_KEY      = C.WIDGET_PROP_MOVE_FOCUS_PREV_KEY
	WIDGET_PROP_MOVE_FOCUS_NEXT_KEY      = C.WIDGET_PROP_MOVE_FOCUS_NEXT_KEY
	WIDGET_PROP_MOVE_FOCUS_UP_KEY        = C.WIDGET_PROP_MOVE_FOCUS_UP_KEY
	WIDGET_PROP_MOVE_FOCUS_DOWN_KEY      = C.WIDGET_PROP_MOVE_FOCUS_DOWN_KEY
	WIDGET_PROP_MOVE_FOCUS_LEFT_KEY      = C.WIDGET_PROP_MOVE_FOCUS_LEFT_KEY
	WIDGET_PROP_MOVE_FOCUS_RIGHT_KEY     = C.WIDGET_PROP_MOVE_FOCUS_RIGHT_KEY
)

type TWidgetState string

const (
	WIDGET_STATE_NONE               = C.WIDGET_STATE_NONE
	WIDGET_STATE_NORMAL             = C.WIDGET_STATE_NORMAL
	WIDGET_STATE_CHANGED            = C.WIDGET_STATE_CHANGED
	WIDGET_STATE_PRESSED            = C.WIDGET_STATE_PRESSED
	WIDGET_STATE_OVER               = C.WIDGET_STATE_OVER
	WIDGET_STATE_DISABLE            = C.WIDGET_STATE_DISABLE
	WIDGET_STATE_FOCUSED            = C.WIDGET_STATE_FOCUSED
	WIDGET_STATE_CHECKED            = C.WIDGET_STATE_CHECKED
	WIDGET_STATE_UNCHECKED          = C.WIDGET_STATE_UNCHECKED
	WIDGET_STATE_EMPTY              = C.WIDGET_STATE_EMPTY
	WIDGET_STATE_EMPTY_FOCUS        = C.WIDGET_STATE_EMPTY_FOCUS
	WIDGET_STATE_ERROR              = C.WIDGET_STATE_ERROR
	WIDGET_STATE_SELECTED           = C.WIDGET_STATE_SELECTED
	WIDGET_STATE_NORMAL_OF_CHECKED  = C.WIDGET_STATE_NORMAL_OF_CHECKED
	WIDGET_STATE_PRESSED_OF_CHECKED = C.WIDGET_STATE_PRESSED_OF_CHECKED
	WIDGET_STATE_OVER_OF_CHECKED    = C.WIDGET_STATE_OVER_OF_CHECKED
	WIDGET_STATE_DISABLE_OF_CHECKED = C.WIDGET_STATE_DISABLE_OF_CHECKED
	WIDGET_STATE_FOCUSED_OF_CHECKED = C.WIDGET_STATE_FOCUSED_OF_CHECKED
	WIDGET_STATE_NORMAL_OF_ACTIVE   = C.WIDGET_STATE_NORMAL_OF_ACTIVE
	WIDGET_STATE_PRESSED_OF_ACTIVE  = C.WIDGET_STATE_PRESSED_OF_ACTIVE
	WIDGET_STATE_OVER_OF_ACTIVE     = C.WIDGET_STATE_OVER_OF_ACTIVE
	WIDGET_STATE_DISABLE_OF_ACTIVE  = C.WIDGET_STATE_DISABLE_OF_ACTIVE
	WIDGET_STATE_FOCUSED_OF_ACTIVE  = C.WIDGET_STATE_FOCUSED_OF_ACTIVE
)

type TWidgetType string

const (
	WIDGET_TYPE_NONE                = C.WIDGET_TYPE_NONE
	WIDGET_TYPE_WINDOW_MANAGER      = C.WIDGET_TYPE_WINDOW_MANAGER
	WIDGET_TYPE_NORMAL_WINDOW       = C.WIDGET_TYPE_NORMAL_WINDOW
	WIDGET_TYPE_OVERLAY             = C.WIDGET_TYPE_OVERLAY
	WIDGET_TYPE_TOOL_BAR            = C.WIDGET_TYPE_TOOL_BAR
	WIDGET_TYPE_DIALOG              = C.WIDGET_TYPE_DIALOG
	WIDGET_TYPE_POPUP               = C.WIDGET_TYPE_POPUP
	WIDGET_TYPE_SYSTEM_BAR          = C.WIDGET_TYPE_SYSTEM_BAR
	WIDGET_TYPE_SYSTEM_BAR_BOTTOM   = C.WIDGET_TYPE_SYSTEM_BAR_BOTTOM
	WIDGET_TYPE_SPRITE              = C.WIDGET_TYPE_SPRITE
	WIDGET_TYPE_KEYBOARD            = C.WIDGET_TYPE_KEYBOARD
	WIDGET_TYPE_DND                 = C.WIDGET_TYPE_DND
	WIDGET_TYPE_LABEL               = C.WIDGET_TYPE_LABEL
	WIDGET_TYPE_BUTTON              = C.WIDGET_TYPE_BUTTON
	WIDGET_TYPE_IMAGE               = C.WIDGET_TYPE_IMAGE
	WIDGET_TYPE_EDIT                = C.WIDGET_TYPE_EDIT
	WIDGET_TYPE_PROGRESS_BAR        = C.WIDGET_TYPE_PROGRESS_BAR
	WIDGET_TYPE_GROUP_BOX           = C.WIDGET_TYPE_GROUP_BOX
	WIDGET_TYPE_CHECK_BUTTON        = C.WIDGET_TYPE_CHECK_BUTTON
	WIDGET_TYPE_RADIO_BUTTON        = C.WIDGET_TYPE_RADIO_BUTTON
	WIDGET_TYPE_DIALOG_TITLE        = C.WIDGET_TYPE_DIALOG_TITLE
	WIDGET_TYPE_DIALOG_CLIENT       = C.WIDGET_TYPE_DIALOG_CLIENT
	WIDGET_TYPE_SLIDER              = C.WIDGET_TYPE_SLIDER
	WIDGET_TYPE_VIEW                = C.WIDGET_TYPE_VIEW
	WIDGET_TYPE_COMBO_BOX           = C.WIDGET_TYPE_COMBO_BOX
	WIDGET_TYPE_COMBO_BOX_ITEM      = C.WIDGET_TYPE_COMBO_BOX_ITEM
	WIDGET_TYPE_SLIDE_VIEW          = C.WIDGET_TYPE_SLIDE_VIEW
	WIDGET_TYPE_SLIDE_INDICATOR     = C.WIDGET_TYPE_SLIDE_INDICATOR
	WIDGET_TYPE_SLIDE_INDICATOR_ARC = C.WIDGET_TYPE_SLIDE_INDICATOR_ARC
	WIDGET_TYPE_PAGES               = C.WIDGET_TYPE_PAGES
	WIDGET_TYPE_TAB_BUTTON          = C.WIDGET_TYPE_TAB_BUTTON
	WIDGET_TYPE_TAB_CONTROL         = C.WIDGET_TYPE_TAB_CONTROL
	WIDGET_TYPE_TAB_BUTTON_GROUP    = C.WIDGET_TYPE_TAB_BUTTON_GROUP
	WIDGET_TYPE_BUTTON_GROUP        = C.WIDGET_TYPE_BUTTON_GROUP
	WIDGET_TYPE_CANDIDATES          = C.WIDGET_TYPE_CANDIDATES
	WIDGET_TYPE_SPIN_BOX            = C.WIDGET_TYPE_SPIN_BOX
	WIDGET_TYPE_DRAGGER             = C.WIDGET_TYPE_DRAGGER
	WIDGET_TYPE_SCROLL_BAR          = C.WIDGET_TYPE_SCROLL_BAR
	WIDGET_TYPE_SCROLL_BAR_DESKTOP  = C.WIDGET_TYPE_SCROLL_BAR_DESKTOP
	WIDGET_TYPE_SCROLL_BAR_MOBILE   = C.WIDGET_TYPE_SCROLL_BAR_MOBILE
	WIDGET_TYPE_SCROLL_VIEW         = C.WIDGET_TYPE_SCROLL_VIEW
	WIDGET_TYPE_LIST_VIEW           = C.WIDGET_TYPE_LIST_VIEW
	WIDGET_TYPE_LIST_VIEW_H         = C.WIDGET_TYPE_LIST_VIEW_H
	WIDGET_TYPE_LIST_ITEM           = C.WIDGET_TYPE_LIST_ITEM
	WIDGET_TYPE_COLOR_PICKER        = C.WIDGET_TYPE_COLOR_PICKER
	WIDGET_TYPE_COLOR_COMPONENT     = C.WIDGET_TYPE_COLOR_COMPONENT
	WIDGET_TYPE_COLOR_TILE          = C.WIDGET_TYPE_COLOR_TILE
	WIDGET_TYPE_CLIP_VIEW           = C.WIDGET_TYPE_CLIP_VIEW
	WIDGET_TYPE_RICH_TEXT           = C.WIDGET_TYPE_RICH_TEXT
	WIDGET_TYPE_APP_BAR             = C.WIDGET_TYPE_APP_BAR
	WIDGET_TYPE_GRID                = C.WIDGET_TYPE_GRID
	WIDGET_TYPE_GRID_ITEM           = C.WIDGET_TYPE_GRID_ITEM
	WIDGET_TYPE_ROW                 = C.WIDGET_TYPE_ROW
	WIDGET_TYPE_COLUMN              = C.WIDGET_TYPE_COLUMN
	WIDGET_TYPE_CALIBRATION_WIN     = C.WIDGET_TYPE_CALIBRATION_WIN
)
...
const (
	WINDOW_CLOSABLE_YES     = C.WINDOW_CLOSABLE_YES
	WINDOW_CLOSABLE_NO      = C.WINDOW_CLOSABLE_NO
	WINDOW_CLOSABLE_CONFIRM = C.WINDOW_CLOSABLE_CONFIRM
)
...
const (
	WINDOW_STAGE_NONE    = C.WINDOW_STAGE_NONE
	WINDOW_STAGE_CREATED = C.WINDOW_STAGE_CREATED
	WINDOW_STAGE_OPENED  = C.WINDOW_STAGE_OPENED
	WINDOW_STAGE_CLOSED  = C.WINDOW_STAGE_CLOSED
	WINDOW_STAGE_SUSPEND = C.WINDOW_STAGE_SUSPEND
)
